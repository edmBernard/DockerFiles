...
all_cpu: tensorflow_cpu_src_py3 tensorflow_cpu_src_py2 pythonlib_cpu ffmpeg_cpu opencv_cpu redis_cpu tensorflow_cpu pytorch_cpu mxnet_cpu_nnpack mxnet_cpu_mkl mxnet_cpu chainer_cpu numba_cpu nnvm_cpu_opencl nnvm_cpu_nnpack nnvm_cpu cntk_cpu chainer_cpu_jupyter jupyter_cpu

all_gpu: tensorflow_gpu_src_py3 tensorflow_gpu_src_py2 pythonlib_gpu ffmpeg_gpu opencv_gpu redis_gpu tensorflow_gpu pytorch_gpu mxnet_gpu chainer_gpu numba_gpu nnvm_gpu_opencl cntk_gpu jupyter_gpu
...
clean_gpu: clean_jupyter_gpu clean_cntk_gpu clean_nnvm_gpu_opencl clean_numba_gpu clean_chainer_gpu clean_mxnet_gpu clean_pytorch_gpu clean_tensorflow_gpu clean_redis_gpu clean_opencv_gpu clean_ffmpeg_gpu clean_pythonlib_gpu clean_tensorflow_gpu_src_py2 clean_tensorflow_gpu_src_py3
...
clean_redis_cpu: clean_jupyter_cpu clean_chainer_cpu_jupyter clean_cntk_cpu clean_nnvm_cpu clean_nnvm_cpu_nnpack clean_nnvm_cpu_opencl clean_numba_cpu clean_chainer_cpu clean_mxnet_cpu clean_mxnet_cpu_mkl clean_mxnet_cpu_nnpack clean_pytorch_cpu clean_tensorflow_cpu
...
clean_opencv_cpu: clean_jupyter_cpu clean_chainer_cpu_jupyter clean_cntk_cpu clean_nnvm_cpu clean_nnvm_cpu_nnpack clean_nnvm_cpu_opencl clean_numba_cpu clean_chainer_cpu clean_mxnet_cpu clean_mxnet_cpu_mkl clean_mxnet_cpu_nnpack clean_pytorch_cpu clean_tensorflow_cpu clean_redis_cpu
...
clean_ffmpeg_cpu: clean_jupyter_cpu clean_chainer_cpu_jupyter clean_cntk_cpu clean_nnvm_cpu clean_nnvm_cpu_nnpack clean_nnvm_cpu_opencl clean_numba_cpu clean_chainer_cpu clean_mxnet_cpu clean_mxnet_cpu_mkl clean_mxnet_cpu_nnpack clean_pytorch_cpu clean_tensorflow_cpu clean_redis_cpu clean_opencv_cpu
