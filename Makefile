...
all_cpu: pythonlib_cpu ffmpeg_cpu opencv_cpu spark_cpu redis_cpu tensorflow_cpu pytorch_cpu mxnet_cpu_nnpack mxnet_cpu_mkl mxnet_cpu chainer_cpu numba_cpu nnvm_cpu_opencl nnvm_cpu_nnpack nnvm_cpu cntk_cpu jupyter_cpu
...
nnvm_gpu_opencl: mxnet_gpu
	docker build $(arg_nocache) -t nnvm_gpu_opencl -f nnvm/Dockerfile.gpu.opencl nnvm
