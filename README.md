...
-p 0.0.0.0:7000:6006            # Port redirection for Tensorboard (redirect host port 7000 to container port 6006)
-p 0.0.0.0:8000:8888            # Port redirection for Jupyter notebook (redirect host port 8000 to container port 8888)
