...
* `tensorflow/Dockerfile.cpu.src` is generated by: 
    ...
    ```bash
    ./generate_amalgamation.py --filename ../tensorflow/Dockerfile.cpu.src --base gcr.io/tensorflow/tensorflow:latest -- pythonlib_cpu opencv_cpu redis_cpu tensorflow_cpu
    ```
